		...
		<section class="body">
			...
			<header class="header">
				<div class="logo-container">
					<a href="../" class="logo">
						<img src="${pageContext.request.contextPath}/admin/index/images/logo.png" height="35" alt="JSOFT Admin" />
					</a>
									...
									<ul>
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="${pageContext.request.contextPath}/admin/index/images/!sample-user.jpg" alt="Joseph Doe Junior" class="img-circle" />
												</figure>
										...
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="${pageContext.request.contextPath}/admin/index/images/!sample-user.jpg" alt="Joseph Junior" class="img-circle" />
												</figure>
										...
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="${pageContext.request.contextPath}/admin/index/images/!sample-user.jpg" alt="Joe Junior" class="img-circle" />
												</figure>
					...
					<div id="userbox" class="userbox">
						<a href="#" data-toggle="dropdown">
							<figure class="profile-picture">
								<img src="${pageContext.request.contextPath}/admin/index/images/!logged-user.jpg" alt="Joseph Doe" class="img-circle" data-lock-picture="${pageContext.request.contextPath}/admin/index/images/!logged-user.jpg" />
							</figure>
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
										...
										<header class="panel-heading bg-primary">
											...
											<div class="widget-profile-info">
												<div class="profile-picture">
													<img src="${pageContext.request.contextPath}/admin/index/images/!logged-user.jpg">
												</div>
												...
												<li>
													<div class="tm-box">
														...
														<div class="thumbnail-gallery">
															<a class="img-thumbnail lightbox" href="${pageContext.request.contextPath}/admin/index/images/projects/project-4.jpg" data-plugin-options='{ "type":"image" }'>
																<img class="img-responsive" width="215" src="${pageContext.request.contextPath}/admin/index/images/projects/project-4.jpg">
																<span class="zoom">
					...
					</div>Copyright &copy; 2020.Company name All rights reserved.<a target="_blank" href="http://sc.chinaz.com/moban/">&#x7F51;&#x9875;&#x6A21;&#x677F;</a>
					<!-- end: page -->
				</section>
			</div>
