            ...
            <div class="page-content-inner pt--75 pb--80">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            <p class="heading-color mb--30 text-center">订单详情</p>
                            <form class="form form--track" action="#">
                            <div class="form__group mb--30">
                                    <label for="order_id" class="form__label">用户ID</label>
                                     <p class="heading-color mb--30 text-center">234567345</p>                             
                                </div>
                                <div class="form__group mb--30">
                                    <label for="order_id" class="form__label">订单ID</label>
                                     <p class="heading-color mb--30 text-center">23456789034567890</p>
                                </div>
                                <div class="form__group mb--30">
                                    <label for="order_id" class="form__label">商品ID</label>
                                     <p class="heading-color mb--30 text-center">234291374234</p>
                                </div>
                                <div class="form__group mb--30">
                                    <label for="order_id" class="form__label">购买数量</label>
                                     <p class="heading-color mb--30 text-center">23</p>
                                </div>
                                <div class="form__group mb--30">
                                    <label for="order_id" class="form__label">下单日期</label>
                                     <p class="heading-color mb--30 text-center">1998.12.12</p>
                                </div>
                                <div class="form__group mb--30">
                                    <label for="order_id" class="form__label">支付日期</label>
                                     <p class="heading-color mb--30 text-center">2020.01.12</p>
                                </div>
                                <div class="form__group mb--30">
                                    <label for="order_id" class="form__label">总额</label>
                                     <p class="heading-color mb--30 text-center">￥1999</p>
                                </div>
                                <div class="form__group mb--30">
                                    <label for="order_id" class="form__label">订单状态</label>
                                     <p class="heading-color mb--30 text-center">0|1|2|3</p>
                                </div>                        
                            </form>
                        </div>
                    </div>
