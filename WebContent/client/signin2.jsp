								...
								<li class="grid"><a class="color2" href="#">MEN</a>
									<div class="megapanel">
										<div class="row">
											...
											<div class="col1 men">
												<div class="men-pic">
													<img src="${pageContext.request.contextPath}/client/images/men.png" title="" />
												</div>
											</div>
										</div>
									</div>
					  			...
					  			<li class="active grid"><a class="color4" href="#">women</a>
									<div class="megapanel">
										<div class="row">
											...
											<div class="col1 women">
												<div class="women-pic">
													<img src="${pageContext.request.contextPath}/client/images/women.png" title="" />
												</div>
											</div>
										</div>
										<div class="row">
									...
									<div class="megapanel">
										<div class="row">
											...
											<div class="col1 kids">
												<div class="kids-pic">
													<img src="${pageContext.request.contextPath}/client/images/kids1.png" title="" />
												</div>
											</div>
											<div class="col1"></div>
											<div class="col1"></div>
										...
										<div class="row">
											...
											<div class="col1 sports">
												<div class="sports-pic">
													<img src="${pageContext.request.contextPath}/client/images/sport.png" title="" />
												</div>
											</div>
										</div>
										<div class="row">
									...
									<div class="megapanel">
										<div class="row">
											...
											<div class="col1 nike">
												<div class="nike-pic">
													<img src="${pageContext.request.contextPath}/client/images/nike.png" title="" />
												</div>
											</div>
										</div>
										<div class="row">
