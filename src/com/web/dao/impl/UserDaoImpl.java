	...
	public Consumer login(String cname, String pswd) {
		...
		try {
			...
			while(rs.next()){
				...
				Consumer.setCNINK(rs.getString("CNICK"));
				...
				Consumer.setEMAIL(rs.getInt("EMAIL"));
				Consumer.setBDAY(rs.getString("BDAY"));
				Consumer.setBDAY(rs.getDate("PSWD"));
